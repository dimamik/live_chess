defmodule LiveChessWeb.Pieces do
  @moduledoc """
  Helper module that renders chess piece SVGs.

  We embed the SVG markup directly so there are no runtime file reads or
  transformations. Assets are the "neo" set sourced from chess.com.
  """
  ...
  @pieces %{
    ...
    {"black", "p"} =>
      ~S|<svg class="piece-svg piece-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81 81"><style>.st1{fill:#010101}.st2{fill:#6d6e6e}.st5,.st6{display:inline;fill:#fff}.st6{fill:#cfcecf}</style><path d="M0 0h81v81H0z" style="fill:none"/><path d="M40.5 12.5c-6 0-10.7 4.8-10.7 10.7 0 3.6 1.8 6.9 4.6 8.8h12.3c2.8-1.9 4.6-5.2 4.6-8.8-.1-6-4.8-10.7-10.8-10.7" class="st1"/><path d="M43.2 16.4c-1.5-.9-3.3-1.1-5.2-.6-3.6 1-5.6 4.6-4.7 8.2 0 .1.1.2.1.3 5.8.7 10.6-5.2 9.8-7.9z" class="st2"/><path d="m34.5 31.7-.3 7.7-3.5 21.7L18.3 72h44.3L50.3 61.1 46 39.4l-.3-7.7" class="st1"/><path d="m37.7 39.6-3.9 22.5-6.6 7.1h7.6l5.2-5.4.1-24.2z" class="st2"/><path d="M26.6 38.8h27.8l-6.7-8H33.3z" class="st1"/><path d="M32.3 36.5h8.8l-2.1-4h-3.8z" class="st2"/></svg>|,
    {"black", "r"} =>
      ~S|<svg class="piece-svg piece-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81 81"><style>.st1{fill:#010101}.st2{fill:#6d6e6e}</style><path d="M0 0h81v81H0z" style="fill:none"/><path d="M56.9 31.1H24.1L19.2 72h42.6z" class="st1"/><path d="M14.2 58.5h52.5V72H14.2z" class="st1"/><path d="M41.1 34.1c-.1 7.2-6.6 24.4-14.2 24.4h-2.3l3.8-24.4h12.7zM18.4 62.3h17.9v6.1H18.4z" class="st2"/><path d="M53.4 12v6.9h-6.9V12h-12v6.9h-6.9V12h-12v11.4l9 9.1h31.8l9-9.1V12z" class="st1"/><path d="M62.4 15h-6v7.2zm-18.9 0h-6v7.2zm-18.9 0h-6v7.2z" class="st2"/></svg>|,
    {"black", "n"} =>
      ~S|<svg class="piece-svg piece-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81 81"><path d="M0 0h81v81H0z" style="fill:none"/><path d="M19.6 72H67l-2-6.1s-.1-17-.1-26.1c0-17.3-8.5-25.3-16-28.4-5.6-2.3-14.6-1.8-14.6-1.8l3.3 6.5L12 36.4l2 12.2 13.4 3.5 6.1-5.1c1.2.5 2.5.8 3.7 1.1v.3S22.9 57 19.6 72zm11.8-40.7c-.6.3-1.1-.5-.6-1l7.2-6.2 2.2 3.7-8.8 3.5z" style="fill:#010101"/><path d="m15.8 38 1.3 7.9 4.7 1.1-.1-4.6-2.9-.5zm15-4.6 15.6-3.8 2.2-3.8s2.8 1.1 2.1 6.3-6.8 8.3-12.1 7.6c-6.9-.9-7.8-6.3-7.8-6.3zM36 67.9c5.1-16.4 16.4-13 16.8-22.4-3.3 5.9-10.7 5.6-10.7 5.6s-11.6 5.1-15.8 16.8H36z" style="fill:#6d6e6e"/></svg>|,
    {"black", "b"} =>
      ~S|<svg class="piece-svg piece-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81 81"><style>.st1{fill:#010101}</style><path d="M0 0h81v81H0z" style="fill:none"/><path d="M18.9 72h43.2l-11.8-9.5H30.7zM41 18.9c1.5 0 2.9-.5 4-1.3l2.8-5.2v-.3c0-3.7-3-6.8-6.8-6.8-3.7 0-6.8 3-6.8 6.8v.3l2.8 5.2c1.2.8 2.6 1.3 4 1.3" class="st1"/><path d="m48.4 20.4-9.7 18.2-1.7-5.9 8.1-15.2c-1-.8-2-1.5-3-2.2H39c-10 6.6-19.1 17.5-19.1 32.2l10.9 15.2h19.4l10.9-15.2c0-11.4-5.5-20.5-12.7-27.1" class="st1"/><path d="m48.6 27.9-7.2 13s5 1.3 7.2-1.9c2.2-3.1 1.6-10.1 0-11.1zM31.2 55.1c-1.6-13.9 1.4-28.1 7.9-34.8l-.5-.7c-7.1 6.3-14 15.6-14 26.6l6.6 8.9zM37.9 69v-5.7h-2.5L28.8 69zm4.5-61.1c-.8-.5-1.8-.6-2.7-.3-1.9.5-3 2.5-2.5 4.4 0 .1 0 .1.1.2 3 .2 5.5-2.9 5.1-4.3z" style="fill:#6d6e6e"/></svg>|,
    {"black", "q"} =>
    ...
    {"black", "k"} =>
      ~S|<svg class="piece-svg piece-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 81 81"><style>.st1{fill:#010101}</style><path d="M0 0h81v81H0z" style="fill:none"/><path d="M58.6 25.5c-6.2 0-9.3 2.6-10.9 4.2l-7.2 12.6-7.2-12.6c-1.6-1.6-4.7-4.2-10.9-4.2-9.7 0-15.3 8-15.3 15.8 0 8.8 3.8 11.9 8.9 22.3V72h49v-8.4c5.1-10.5 8.9-13.5 8.9-22.3 0-7.8-5.6-15.8-15.3-15.8zM40.5 61.6l-3.6-6.4 3.6-6.4 3.6 6.4-3.6 6.4z" class="st1"/><path d="M50.7 21.4v-7.7l-8 .9 1.7-7.4h-7.8l1.7 7.4-8-.9v7.7l8-2.4-3.1 8.9 5.3 11 5.3-11-3.1-8.9z" class="st1"/><path d="m40.5 19.9-2.9 7.6 2.9 6.4zm-17.7 9.2c-7.2 0-11.7 6.4-11.7 12.9 0 4 2.9 8.2 5.8 12 0-12.4 4.6-17.4 12.5-22.6 0 0-2-2.3-6.6-2.3zM43.5 44l7.4-12.7s3.6-2.6 8-2.6 4.5.5 4.5.5L43.5 44zM31.8 15.1l3.8 2.3-3.8 2.3zm17.4 0-6.4 1.2 4.7 1.1zm-6.6-6.2-2.1 1.9-2.1-1.9z" style="fill:#6d6e6e"/></svg>|
  }
  ...
  def piece_svg(%{color: color, type: type}) do
    ...
    case Map.fetch(@pieces, key) do
      {:ok, svg} -> raw(svg)
      :error -> nil
    end
  end

  def piece_svg(_), do: nil
  ...
  defp normalize_type(type) do
    ...
    |> case do
      ...
      "queen" -> "q"
      "king" -> "k"
      <<letter::utf8, _rest::binary>> -> <<letter::utf8>>
      <<letter::utf8>> -> <<letter::utf8>>
      _ -> "p"
    end
  end
end
